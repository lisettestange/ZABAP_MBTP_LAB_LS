CLASS zcl_data_file_upload_ls DEFINITION
  PUBLIC
  CREATE PUBLIC .
...
CLASS zcl_data_file_upload_ls IMPLEMENTATION.

  METHOD if_http_service_extension~handle_request.
*    "este metodo se invoca cuando se llama el servicio http
    CASE request->get_method(  ).
*   peticion get es ver si tiene datos en la cabecera de la tabla
